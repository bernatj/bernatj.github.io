...
{% include video.liquid path="assets/video/cyclone_ciaran_fcnv2_grib_factual_minus2_to_plus2days.mp4" class="img-fluid rounded z-depth-1" controls=true autoplay=false loop=false %}
