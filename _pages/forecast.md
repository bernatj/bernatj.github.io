...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026061412 -->
  <button class="fc-date-btn active" onclick="selectDate('2026061612')">2026-06-16 12Z &#9733;</button>
  <button class="fc-date-btn" onclick="selectDate('2026061606')">2026-06-16 06Z</button>
...
<script>
var latestInit   = '2026061612';
var currentModel = 'pangu';
var currentDate  = '2026061612';
...
<em>Last updated: 2026-06-14 12:00 UTC</em> &nbsp;&middot;&nbsp;
