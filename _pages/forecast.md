...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026090900 -->
  <button class="fc-date-btn active" onclick="selectDate('2026091100')">2026-09-11 00Z &#9733;</button>
  ...
  <button class="fc-date-btn" onclick="selectDate('2026090912')">2026-09-09 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026090906')">2026-09-09 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026090900')">2026-09-09 00Z</button>
...
<script>
var latestInit   = '2026091100';
var currentModel = 'pangu';
var currentDate  = '2026091100';
...
<em>Last updated: 2026-09-09 00:00 UTC</em> &nbsp;&middot;&nbsp;
