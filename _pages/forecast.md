...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026062918 -->
  <button class="fc-date-btn active" onclick="selectDate('2026070118')">2026-07-01 18Z &#9733;</button>
  <button class="fc-date-btn" onclick="selectDate('2026070112')">2026-07-01 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026070106')">2026-07-01 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026070100')">2026-07-01 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026063018')">2026-06-30 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026063012')">2026-06-30 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026063006')">2026-06-30 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026063000')">2026-06-30 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026062918')">2026-06-29 18Z</button>
...
<script>
var latestInit   = '2026070118';
var currentModel = 'pangu';
var currentDate  = '2026070118';
...
<em>Last updated: 2026-06-29 18:00 UTC</em> &nbsp;&middot;&nbsp;
