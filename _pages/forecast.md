...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026090700 -->
  <button class="fc-date-btn active" onclick="selectDate('2026090900')">2026-09-09 00Z &#9733;</button>
  <button class="fc-date-btn" onclick="selectDate('2026090818')">2026-09-08 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026090812')">2026-09-08 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026090806')">2026-09-08 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026090800')">2026-09-08 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026090718')">2026-09-07 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026090712')">2026-09-07 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026090706')">2026-09-07 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026090700')">2026-09-07 00Z</button>
...
<script>
var latestInit   = '2026090900';
var currentModel = 'pangu';
var currentDate  = '2026090900';
...
<em>Last updated: 2026-09-07 00:00 UTC</em> &nbsp;&middot;&nbsp;
