...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026082900 -->
  <button class="fc-date-btn active" onclick="selectDate('2026083100')">2026-08-31 00Z &#9733;</button>
  <button class="fc-date-btn" onclick="selectDate('2026083018')">2026-08-30 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026083012')">2026-08-30 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026083006')">2026-08-30 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026083000')">2026-08-30 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026082918')">2026-08-29 18Z</button>
...
<script>
var latestInit   = '2026083100';
var currentModel = 'pangu';
var currentDate  = '2026083100';
...
<em>Last updated: 2026-08-29 00:00 UTC</em> &nbsp;&middot;&nbsp;
