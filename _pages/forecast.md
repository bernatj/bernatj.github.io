...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026090312 -->
  <button class="fc-date-btn active" onclick="selectDate('2026090512')">2026-09-05 12Z &#9733;</button>
  <button class="fc-date-btn" onclick="selectDate('2026090506')">2026-09-05 06Z</button>
...
<script>
var latestInit   = '2026090512';
var currentModel = 'pangu';
var currentDate  = '2026090512';
...
<em>Last updated: 2026-09-03 12:00 UTC</em> &nbsp;&middot;&nbsp;
