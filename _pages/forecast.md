...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026082312 -->
  <button class="fc-date-btn active" onclick="selectDate('2026082512')">2026-08-25 12Z &#9733;</button>
  ...
  <button class="fc-date-btn" onclick="selectDate('2026082318')">2026-08-23 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026082312')">2026-08-23 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026082306')">2026-08-23 06Z</button>
  <!-- DATE_BUTTONS_END -->
</div>
...
<script>
var latestInit   = '2026082512';
var currentModel = 'pangu';
var currentDate  = '2026082512';
...
<em>Last updated: 2026-08-23 12:00 UTC</em> &nbsp;&middot;&nbsp;
