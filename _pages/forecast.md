...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026072006 -->
  <button class="fc-date-btn active" onclick="selectDate('2026072206')">2026-07-22 06Z &#9733;</button>
  ...
  <button class="fc-date-btn" onclick="selectDate('2026072006')">2026-07-20 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026072000')">2026-07-20 00Z</button>
  <!-- DATE_BUTTONS_END -->
</div>
...
<script>
var latestInit   = '2026072206';
var currentModel = 'pangu';
var currentDate  = '2026072206';
...
<em>Last updated: 2026-07-20 06:00 UTC</em> &nbsp;&middot;&nbsp;
