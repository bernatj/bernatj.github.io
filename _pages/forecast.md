...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026070106 -->
  <button class="fc-date-btn active" onclick="selectDate('2026070306')">2026-07-03 06Z &#9733;</button>
  <button class="fc-date-btn" onclick="selectDate('2026070300')">2026-07-03 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026070218')">2026-07-02 18Z</button>
...
<script>
var latestInit   = '2026070306';
var currentModel = 'pangu';
var currentDate  = '2026070306';
...
<em>Last updated: 2026-07-01 06:00 UTC</em> &nbsp;&middot;&nbsp;
