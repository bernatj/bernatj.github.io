...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026073118 -->
  <button class="fc-date-btn active" onclick="selectDate('2026080218')">2026-08-02 18Z &#9733;</button>
  <button class="fc-date-btn" onclick="selectDate('2026080212')">2026-08-02 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026080206')">2026-08-02 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026080200')">2026-08-02 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026080118')">2026-08-01 18Z</button>
...
<script>
var latestInit   = '2026080218';
var currentModel = 'pangu';
var currentDate  = '2026080218';
...
<em>Last updated: 2026-07-31 18:00 UTC</em> &nbsp;&middot;&nbsp;
