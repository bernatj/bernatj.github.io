...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026090500 -->
  <button class="fc-date-btn active" onclick="selectDate('2026090700')">2026-09-07 00Z &#9733;</button>
  <button class="fc-date-btn" onclick="selectDate('2026090618')">2026-09-06 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026090612')">2026-09-06 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026090606')">2026-09-06 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026090600')">2026-09-06 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026090518')">2026-09-05 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026090512')">2026-09-05 12Z</button>
...
<script>
var latestInit   = '2026090700';
var currentModel = 'pangu';
var currentDate  = '2026090700';
...
<em>Last updated: 2026-09-05 00:00 UTC</em> &nbsp;&middot;&nbsp;
