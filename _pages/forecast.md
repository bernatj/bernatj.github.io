...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026080606 -->
  <button class="fc-date-btn active" onclick="selectDate('2026080806')">2026-08-08 06Z &#9733;</button>
  ...
  <button class="fc-date-btn" onclick="selectDate('2026080700')">2026-08-07 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026080618')">2026-08-06 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026080612')">2026-08-06 12Z</button>
...
<script>
var latestInit   = '2026080806';
var currentModel = 'pangu';
var currentDate  = '2026080806';
...
<em>Last updated: 2026-08-06 06:00 UTC</em> &nbsp;&middot;&nbsp;
