...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026071806 -->
  <button class="fc-date-btn active" onclick="selectDate('2026072006')">2026-07-20 06Z &#9733;</button>
  ...
  <button class="fc-date-btn" onclick="selectDate('2026071900')">2026-07-19 00Z</button>
...
<script>
var latestInit   = '2026072006';
var currentModel = 'pangu';
var currentDate  = '2026072006';
...
<em>Last updated: 2026-07-18 06:00 UTC</em> &nbsp;&middot;&nbsp;
