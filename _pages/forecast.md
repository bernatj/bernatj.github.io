...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026081418 -->
  <button class="fc-date-btn active" onclick="selectDate('2026081618')">2026-08-16 18Z &#9733;</button>
  ...
  <button class="fc-date-btn" onclick="selectDate('2026081500')">2026-08-15 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026081418')">2026-08-14 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026081412')">2026-08-14 12Z</button>
  <!-- DATE_BUTTONS_END -->
</div>
...
<script>
var latestInit   = '2026081618';
var currentModel = 'pangu';
var currentDate  = '2026081618';
...
<em>Last updated: 2026-08-14 18:00 UTC</em> &nbsp;&middot;&nbsp;
