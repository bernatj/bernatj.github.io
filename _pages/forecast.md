...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026061400 -->
  <button class="fc-date-btn active" onclick="selectDate('2026061600')">2026-06-16 00Z &#9733;</button>
  <button class="fc-date-btn" onclick="selectDate('2026061518')">2026-06-15 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026061512')">2026-06-15 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026061506')">2026-06-15 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026061500')">2026-06-15 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026061418')">2026-06-14 18Z</button>
...
<script>
var latestInit   = '2026061600';
var currentModel = 'pangu';
var currentDate  = '2026061600';
...
<em>Last updated: 2026-06-14 00:00 UTC</em> &nbsp;&middot;&nbsp;
