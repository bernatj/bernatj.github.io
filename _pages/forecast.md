...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026082612 -->
  <button class="fc-date-btn active" onclick="selectDate('2026082812')">2026-08-28 12Z &#9733;</button>
  <button class="fc-date-btn" onclick="selectDate('2026082806')">2026-08-28 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026082800')">2026-08-28 00Z</button>
...
<script>
var latestInit   = '2026082812';
var currentModel = 'pangu';
var currentDate  = '2026082812';
...
<em>Last updated: 2026-08-26 12:00 UTC</em> &nbsp;&middot;&nbsp;
