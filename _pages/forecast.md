...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026082512 -->
  <button class="fc-date-btn active" onclick="selectDate('2026082712')">2026-08-27 12Z &#9733;</button>
  <button class="fc-date-btn" onclick="selectDate('2026082706')">2026-08-27 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026082700')">2026-08-27 00Z</button>
...
<script>
var latestInit   = '2026082712';
var currentModel = 'pangu';
var currentDate  = '2026082712';
...
<em>Last updated: 2026-08-25 12:00 UTC</em> &nbsp;&middot;&nbsp;
