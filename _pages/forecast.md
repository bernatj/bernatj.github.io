...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026071912 -->
  <button class="fc-date-btn active" onclick="selectDate('2026072112')">2026-07-21 12Z &#9733;</button>
  ...
  <button class="fc-date-btn" onclick="selectDate('2026071918')">2026-07-19 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026071912')">2026-07-19 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026071906')">2026-07-19 06Z</button>
  <!-- DATE_BUTTONS_END -->
</div>
...
<script>
var latestInit   = '2026072112';
var currentModel = 'pangu';
var currentDate  = '2026072112';
...
<em>Last updated: 2026-07-19 12:00 UTC</em> &nbsp;&middot;&nbsp;
