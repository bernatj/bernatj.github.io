...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <button class="fc-date-btn active" onclick="selectDate('2026060906')">2026-06-07 06Z &#9733;</button>
  ...
  <button class="fc-date-btn" onclick="selectDate('2026061012')">2026-06-08 12Z</button>
  <!-- DATE_BUTTONS_END -->
</div>
