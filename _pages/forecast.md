...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026083106 -->
  <button class="fc-date-btn active" onclick="selectDate('2026090206')">2026-09-02 06Z &#9733;</button>
  ...
  <button class="fc-date-btn" onclick="selectDate('2026090106')">2026-09-01 06Z</button>
...
<script>
var latestInit   = '2026090206';
var currentModel = 'pangu';
var currentDate  = '2026090206';
...
<em>Last updated: 2026-08-31 06:00 UTC</em> &nbsp;&middot;&nbsp;
