...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026081718 -->
  <button class="fc-date-btn active" onclick="selectDate('2026081918')">2026-08-19 18Z &#9733;</button>
  ...
  <button class="fc-date-btn" onclick="selectDate('2026081712')">2026-08-17 12Z</button>
  <!-- DATE_BUTTONS_END -->
</div>
...
<script>
var latestInit   = '2026081918';
var currentModel = 'pangu';
var currentDate  = '2026081918';
...
<em>Last updated: 2026-08-17 18:00 UTC</em> &nbsp;&middot;&nbsp;
