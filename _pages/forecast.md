...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026061012 -->
  <button class="fc-date-btn active" onclick="selectDate('2026061212')">2026-06-12 12Z &#9733;</button>
  <button class="fc-date-btn" onclick="selectDate('2026061206')">2026-06-12 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026061200')">2026-06-12 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026061118')">2026-06-11 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026061112')">2026-06-11 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026061106')">2026-06-11 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026061100')">2026-06-11 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026061018')">2026-06-10 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026061012')">2026-06-10 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026061006')">2026-06-10 06Z</button>
  <!-- DATE_BUTTONS_END -->
</div>
...
<script>
var latestInit   = '2026061212';
var currentModel = 'pangu';
var currentDate  = '2026061212';
...
<em>Last updated: 2026-06-10 12:00 UTC</em> &nbsp;&middot;&nbsp;
