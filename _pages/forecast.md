...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026091118 -->
  <button class="fc-date-btn active" onclick="selectDate('2026091318')">2026-09-13 18Z &#9733;</button>
  <button class="fc-date-btn" onclick="selectDate('2026091312')">2026-09-13 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026091306')">2026-09-13 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026091300')">2026-09-13 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026091218')">2026-09-12 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026091212')">2026-09-12 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026091206')">2026-09-12 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026091200')">2026-09-12 00Z</button>
...
<script>
var latestInit   = '2026091318';
var currentModel = 'pangu';
var currentDate  = '2026091318';
...
<em>Last updated: 2026-09-11 18:00 UTC</em> &nbsp;&middot;&nbsp;
