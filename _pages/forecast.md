...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026072712 -->
  <button class="fc-date-btn active" onclick="selectDate('2026072912')">2026-07-29 12Z &#9733;</button>
  ...
  <button class="fc-date-btn" onclick="selectDate('2026072712')">2026-07-27 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026072706')">2026-07-27 06Z</button>
  <!-- DATE_BUTTONS_END -->
</div>
...
<script>
var latestInit   = '2026072912';
var currentModel = 'pangu';
var currentDate  = '2026072912';
...
<em>Last updated: 2026-07-27 12:00 UTC</em> &nbsp;&middot;&nbsp;
