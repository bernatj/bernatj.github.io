...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026071600 -->
  <button class="fc-date-btn active" onclick="selectDate('2026071800')">2026-07-18 00Z &#9733;</button>
  ...
  <button class="fc-date-btn" onclick="selectDate('2026071606')">2026-07-16 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026071600')">2026-07-16 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026071518')">2026-07-15 18Z</button>
  <!-- DATE_BUTTONS_END -->
</div>
...
<script>
var latestInit   = '2026071800';
var currentModel = 'pangu';
var currentDate  = '2026071800';
...
<em>Last updated: 2026-07-16 00:00 UTC</em> &nbsp;&middot;&nbsp;
