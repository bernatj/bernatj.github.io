...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026070518 -->
  <button class="fc-date-btn active" onclick="selectDate('2026070718')">2026-07-07 18Z &#9733;</button>
  <button class="fc-date-btn" onclick="selectDate('2026070712')">2026-07-07 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026070706')">2026-07-07 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026070700')">2026-07-07 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026070618')">2026-07-06 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026070612')">2026-07-06 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026070606')">2026-07-06 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026070600')">2026-07-06 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026070518')">2026-07-05 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026070512')">2026-07-05 12Z</button>
  <!-- DATE_BUTTONS_END -->
</div>
...
<script>
var latestInit   = '2026070718';
var currentModel = 'pangu';
var currentDate  = '2026070718';
...
<em>Last updated: 2026-07-05 18:00 UTC</em> &nbsp;&middot;&nbsp;
