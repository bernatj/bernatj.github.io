...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <button class="fc-date-btn" onclick="selectDate('2026060900')">2026-06-07 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026060818')">2026-06-06 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026060812')">2026-06-06 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026060806')">2026-06-06 06Z</button>
  <!-- DATE_BUTTONS_END -->
</div>
