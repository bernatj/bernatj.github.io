...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026080306 -->
  <button class="fc-date-btn active" onclick="selectDate('2026080506')">2026-08-05 06Z &#9733;</button>
  ...
  <button class="fc-date-btn" onclick="selectDate('2026080400')">2026-08-04 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026080318')">2026-08-03 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026080312')">2026-08-03 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026080306')">2026-08-03 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026080300')">2026-08-03 00Z</button>
  <!-- DATE_BUTTONS_END -->
</div>
...
<script>
var latestInit   = '2026080506';
var currentModel = 'pangu';
var currentDate  = '2026080506';
...
<em>Last updated: 2026-08-03 06:00 UTC</em> &nbsp;&middot;&nbsp;
