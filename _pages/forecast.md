...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026062406 -->
  <button class="fc-date-btn active" onclick="selectDate('2026062606')">2026-06-26 06Z &#9733;</button>
  <button class="fc-date-btn" onclick="selectDate('2026062600')">2026-06-26 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026062518')">2026-06-25 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026062512')">2026-06-25 12Z</button>
...
<script>
var latestInit   = '2026062606';
var currentModel = 'pangu';
var currentDate  = '2026062606';
...
<em>Last updated: 2026-06-24 06:00 UTC</em> &nbsp;&middot;&nbsp;
