...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026082912 -->
  <button class="fc-date-btn active" onclick="selectDate('2026083112')">2026-08-31 12Z &#9733;</button>
  <button class="fc-date-btn" onclick="selectDate('2026083106')">2026-08-31 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026083100')">2026-08-31 00Z</button>
...
<script>
var latestInit   = '2026083112';
var currentModel = 'pangu';
var currentDate  = '2026083112';
...
<em>Last updated: 2026-08-29 12:00 UTC</em> &nbsp;&middot;&nbsp;
