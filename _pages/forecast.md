...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026083006 -->
  <button class="fc-date-btn active" onclick="selectDate('2026090106')">2026-09-01 06Z &#9733;</button>
  <button class="fc-date-btn" onclick="selectDate('2026090100')">2026-09-01 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026083118')">2026-08-31 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026083112')">2026-08-31 12Z</button>
...
<script>
var latestInit   = '2026090106';
var currentModel = 'pangu';
var currentDate  = '2026090106';
...
<em>Last updated: 2026-08-30 06:00 UTC</em> &nbsp;&middot;&nbsp;
