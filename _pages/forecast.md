...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026061000 -->
  <button class="fc-date-btn active" onclick="selectDate('2026061200')">2026-06-12 00Z &#9733;</button>
  ...
  <button class="fc-date-btn" onclick="selectDate('2026060918')">2026-06-09 18Z</button>
  <!-- DATE_BUTTONS_END -->
</div>
...
<script>
var latestInit   = '2026061200';
var currentModel = 'pangu';
var currentDate  = '2026061200';
...
<em>Last updated: 2026-06-10 00:00 UTC</em> &nbsp;&middot;&nbsp;
