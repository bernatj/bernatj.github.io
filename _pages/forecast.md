...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026080218 -->
  <button class="fc-date-btn active" onclick="selectDate('2026080418')">2026-08-04 18Z &#9733;</button>
  ...
  <button class="fc-date-btn" onclick="selectDate('2026080218')">2026-08-02 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026080212')">2026-08-02 12Z</button>
  <!-- DATE_BUTTONS_END -->
</div>
...
<script>
var latestInit   = '2026080418';
var currentModel = 'pangu';
var currentDate  = '2026080418';
...
<em>Last updated: 2026-08-02 18:00 UTC</em> &nbsp;&middot;&nbsp;
