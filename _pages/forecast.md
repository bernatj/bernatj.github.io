...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026071112 -->
  <button class="fc-date-btn active" onclick="selectDate('2026071312')">2026-07-13 12Z &#9733;</button>
  <button class="fc-date-btn" onclick="selectDate('2026071306')">2026-07-13 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026071300')">2026-07-13 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026071218')">2026-07-12 18Z</button>
...
<script>
var latestInit   = '2026071312';
var currentModel = 'pangu';
var currentDate  = '2026071312';
...
<em>Last updated: 2026-07-11 12:00 UTC</em> &nbsp;&middot;&nbsp;
