...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026081000 -->
  <button class="fc-date-btn active" onclick="selectDate('2026081200')">2026-08-12 00Z &#9733;</button>
  <button class="fc-date-btn" onclick="selectDate('2026081118')">2026-08-11 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026081112')">2026-08-11 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026081106')">2026-08-11 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026081100')">2026-08-11 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026081018')">2026-08-10 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026081012')">2026-08-10 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026081006')">2026-08-10 06Z</button>
...
<script>
var latestInit   = '2026081200';
var currentModel = 'pangu';
var currentDate  = '2026081200';
...
<em>Last updated: 2026-08-10 00:00 UTC</em> &nbsp;&middot;&nbsp;
