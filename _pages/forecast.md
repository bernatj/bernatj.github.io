...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026082406 -->
  <button class="fc-date-btn active" onclick="selectDate('2026082606')">2026-08-26 06Z &#9733;</button>
  ...
  <button class="fc-date-btn" onclick="selectDate('2026082412')">2026-08-24 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026082406')">2026-08-24 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026082400')">2026-08-24 00Z</button>
  <!-- DATE_BUTTONS_END -->
</div>
...
<script>
var latestInit   = '2026082606';
var currentModel = 'pangu';
var currentDate  = '2026082606';
...
<em>Last updated: 2026-08-24 06:00 UTC</em> &nbsp;&middot;&nbsp;
