...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026072406 -->
  <button class="fc-date-btn active" onclick="selectDate('2026072606')">2026-07-26 06Z &#9733;</button>
  <button class="fc-date-btn" onclick="selectDate('2026072600')">2026-07-26 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026072518')">2026-07-25 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026072512')">2026-07-25 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026072506')">2026-07-25 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026072500')">2026-07-25 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026072418')">2026-07-24 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026072412')">2026-07-24 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026072406')">2026-07-24 06Z</button>
...
<script>
var latestInit   = '2026072606';
var currentModel = 'pangu';
var currentDate  = '2026072606';
...
<em>Last updated: 2026-07-24 06:00 UTC</em> &nbsp;&middot;&nbsp;
