...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026082106 -->
  <button class="fc-date-btn active" onclick="selectDate('2026082306')">2026-08-23 06Z &#9733;</button>
  <button class="fc-date-btn" onclick="selectDate('2026082300')">2026-08-23 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026082218')">2026-08-22 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026082212')">2026-08-22 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026082206')">2026-08-22 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026082200')">2026-08-22 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026082118')">2026-08-21 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026082112')">2026-08-21 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026082106')">2026-08-21 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026082100')">2026-08-21 00Z</button>
  <!-- DATE_BUTTONS_END -->
</div>
...
<script>
var latestInit   = '2026082306';
var currentModel = 'pangu';
var currentDate  = '2026082306';
...
<em>Last updated: 2026-08-21 06:00 UTC</em> &nbsp;&middot;&nbsp;
