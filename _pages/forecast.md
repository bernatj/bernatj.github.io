...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026090118 -->
  <button class="fc-date-btn active" onclick="selectDate('2026090318')">2026-09-03 18Z &#9733;</button>
  ...
  <button class="fc-date-btn" onclick="selectDate('2026090212')">2026-09-02 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026090206')">2026-09-02 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026090200')">2026-09-02 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026090118')">2026-09-01 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026090112')">2026-09-01 12Z</button>
  <!-- DATE_BUTTONS_END -->
</div>
...
<script>
var latestInit   = '2026090318';
var currentModel = 'pangu';
var currentDate  = '2026090318';
...
<em>Last updated: 2026-09-01 18:00 UTC</em> &nbsp;&middot;&nbsp;
