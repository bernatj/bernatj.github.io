...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026080806 -->
  <button class="fc-date-btn active" onclick="selectDate('2026081006')">2026-08-10 06Z &#9733;</button>
  <button class="fc-date-btn" onclick="selectDate('2026081000')">2026-08-10 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026080918')">2026-08-09 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026080912')">2026-08-09 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026080906')">2026-08-09 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026080900')">2026-08-09 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026080818')">2026-08-08 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026080812')">2026-08-08 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026080806')">2026-08-08 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026080800')">2026-08-08 00Z</button>
  <!-- DATE_BUTTONS_END -->
</div>
...
<script>
var latestInit   = '2026081006';
var currentModel = 'pangu';
var currentDate  = '2026081006';
...
<em>Last updated: 2026-08-08 06:00 UTC</em> &nbsp;&middot;&nbsp;
