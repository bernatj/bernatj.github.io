...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin:0 0 28px;align-items:center;">
  ...
  <!-- DATE_BUTTONS_START -->
  <!-- LATEST_INIT:2026070412 -->
  <button class="fc-date-btn active" onclick="selectDate('2026070612')">2026-07-06 12Z &#9733;</button>
  ...
  <button class="fc-date-btn" onclick="selectDate('2026070506')">2026-07-05 06Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026070500')">2026-07-05 00Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026070418')">2026-07-04 18Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026070412')">2026-07-04 12Z</button>
  <button class="fc-date-btn" onclick="selectDate('2026070406')">2026-07-04 06Z</button>
  <!-- DATE_BUTTONS_END -->
</div>
...
<script>
var latestInit   = '2026070612';
var currentModel = 'pangu';
var currentDate  = '2026070612';
...
<em>Last updated: 2026-07-04 12:00 UTC</em> &nbsp;&middot;&nbsp;
